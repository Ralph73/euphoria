    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (result.success) {
            Swal.fire({
                icon: 'success',
                title: '¡Skill creada!',
                text: 'La habilidad se ha creado correctamente',
                timer: 2000,
            ...
            setError(result.error || 'Error al crear la skill');
            Swal.fire({
                icon: 'error',
                title: 'Error',
                text: result.error || 'Error al crear la skill',
                background: '#1f2937',
                color: '#ffffff',
                customClass: { popup: 'rounded-2xl' }
            });
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-velvet-orchid-500 mt-0.5">
                                            Completa los campos para crear una nueva habilidad
                                        </p>
                                    </div>
                                </div>
                                <button
